...
// Add item to cart from main html card
function innerAddToCartAfterFilter(movie_title, short_movie_title, price) {
...
function movieOuterAddToCartAfterFilter(i) {
    var movie_title = document.getElementsByClassName("movie" + i)[0].innerText
    var short_movie_title = movie_title.split(" ").join("")
    var price = Number(document.getElementsByClassName("movie-price" + i)[0].innerText.substring(6).replace("$", ""))
    innerAddToCartAfterFilter(movie_title, short_movie_title, price)
}

function tvOuterAddToCartAfterFilter(i) {
    var movie_title = document.getElementsByClassName("tv" + i)[0].innerText
    var short_movie_title = movie_title.split(" ").join("")
    var price = Number(document.getElementsByClassName("tv-price" + i)[0].innerText.substring(6).replace("$", ""))
    innerAddToCartAfterFilter(movie_title, short_movie_title, price)
}